      ...
      <View style={{ flex: 1, backgroundColor: COLOURS.bg }}>
        ...
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 48 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 10, marginBottom: 20, flexWrap: 'wrap' }}>
            ...
            <View style={{ paddingHorizontal: 14, paddingVertical: 8, borderRadius: RADIUS.pill, backgroundColor: COLOURS.navy }}>
          ...
          {/* Wins + focus */}
          {session.wins ? (
            <View style={{ marginBottom: 16, padding: 14, backgroundColor: 'rgba(255,255,255,0.55)', borderRadius: RADIUS.md, borderWidth: 1, borderColor: COLOURS.glassBorder }}>
